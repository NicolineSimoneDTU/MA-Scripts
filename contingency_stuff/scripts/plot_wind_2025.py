...
### plot dispatch by carrier
def plot_dispatch_by_carrier(n, outage_start, outage_end):
    
    # dispatch of generators, stores and storage units
...
### plot electricity load shedding
...
if __name__ == "__main__":
    ...
    outdir = f"results_contingencies/2025/wind_2025/{scenario}/plots"
